---
title: Understand and configure Azure Active Directory Application Proxy Complex applications
description: Provides an understanding and setup instructions of Complex applications in Azure Active Directory Application Proxy. 
...
# Complex Applications in Azure Active Directory Application Proxy
...
### Option 1: Set up a wildcard application

Create a Azure AD Application Proxy [wildcard application](./application-proxy-wildcard.md) to publish from the same origin, without having to make any changes to app origins, code, or headers. 
